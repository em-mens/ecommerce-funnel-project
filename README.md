...
## Business Question
This project addresses the problem of potential lost revenue across the purchase funnel. The goal was to identify the stage at which the steepest drop-off occurs, quantify the revenue impact, and determine whether conversion differs by acquisition channel.
